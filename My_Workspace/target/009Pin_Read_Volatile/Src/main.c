...
{
    /* Loop forever */
	uint32_t volatile *pClkCtrlReg = (uint32_t*)0x40023830;  //Calculated for clock control register of RCC (AHB1ENR)
	uint32_t volatile *pPortDModeReg = (uint32_t*)0x40020C00; //Address of GPIOD mode register (ctrl mode)
